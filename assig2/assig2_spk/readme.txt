...
Unzip the contents of this zip file with the unzip command. Cd to the correct directory and run "make", without quotes, to compile and link the c and header files. Three executable files will be produced, at, at2,and at3.
